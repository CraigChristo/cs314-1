...
public static void main(String args[])
{
    ...
    bart.mMngr.playSong(Bob, Bob.getLibrary().getBorrowedSong("Funkotonic", "Funktimus Prime"));
    bart.mMngr.playSong(Bob, Bob.getLibrary().getBorrowedSong("Funkotonic", "Funktimus Prime"));
    bart.mMngr.playSong(Bob, Bob.getLibrary().getBorrowedSong("Funkotonic", "Funktimus Prime"));
    bart.getUser().getLibrary().returnBorrow(Bob, Bob.getLibrary().getBorrowedSong("Funkotonic", "Funktimus Prime"));
    bart.mMngr.borrowToLib(bart.getUser(), Bob, bart.getUser().getLibrary().getOwnedSong("Funkotonic", "Funktimus Prime"));
    bart.getUser().getLibrary().returnBorrow(Bob, Bob.getLibrary().getBorrowedSong("Funkotonic", "Funktimus Prime"));
    bart.mMngr.borrowToLib(bart.getUser(), Bob, bart.getUser().getLibrary().getOwnedSong("Funkotonic", "Funktimus Prime"));
    bart.getUser().getLibrary().returnBorrow(Bob, Bob.getLibrary().getBorrowedSong("Funkotonic", "Funktimus Prime"));
